...
COURSE_INFO_1K = {
    ...
    'CS1231S': {
        ...
        'materials': {
            ...
            'Cheatsheet': {
                'Midterm': ['https://drive.google.com/file/d/1eCDBd9u__fB-FaVfY92TwNCgf76zujvK/view?usp=sharing'],
                'Final': ['https://drive.google.com/file/d/1eCDBd9u__fB-FaVfY92TwNCgf76zujvK/view?usp=sharing']
            },
            'Past Papers': {
                'Midterm': {
